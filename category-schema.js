  ...
  technology: {
    ...
    subcategories: {
      ai_tech: {
        ...
        keywords: ["ChatGPT使用技巧", "AI绘画教程", "机器学习入门", "深度学习框架", "神经网络原理", "算法可视化", "AI工具测评", "大模型应用", "自动驾驶技术", "计算机视觉"]
      },
      hardware_tech: {
        name: "硬件科技", 
        description: "电子设备、芯片、硬件创新等",
        keywords: ["iPhone评测", "华为芯片", "显卡性能测试", "笔记本拆机", "手机摄影对比", "5G网络体验", "智能手表功能", "耳机音质测评", "电脑组装教程", "数码产品开箱"]
      },
      software_dev: {
        name: "软件开发",
        description: "编程、软件工程、开发技术等",
        keywords: ["Python教程", "前端开发技巧", "Java编程实战", "Vue框架学习", "React项目实践", "数据库设计", "Git版本控制", "编程面试题", "开源项目分析", "代码重构技巧"]
      },
      digital_life: {
        name: "数字生活",
        description: "数字化应用、智能生活、科技体验等",
        keywords: ["智能家居搭建", "好用的APP推荐", "数字化办公", "云存储技巧", "智能音箱体验", "扫地机器人测评", "在线学习平台", "数字支付安全", "智能穿戴设备", "远程办公工具"]
      }
    }
  },
